...
**Sub-agent 1: Concepts & Metrics** (`name: "source-research-concepts"`)
...
**Sub-agent 2: Practices & Edge Cases** (`name: "source-research-practices"`)

- Input: concept research text (passed in the prompt)
- Returns: clarification text about practices and edge cases

**Sub-agent 3: Technical Implementation** (`name: "source-research-implementation"`)
