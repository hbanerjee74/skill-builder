---
# AUTO-GENERATED — do not edit. Source: agent-sources/templates/research-implementation.md + agent-sources/types/source/config.conf
# Regenerate with: scripts/build-agents.sh
name: source-research-implementation
...
Focus on API schema mapping, data type coercion, schema evolution handling, and source-specific data quality gotchas.
