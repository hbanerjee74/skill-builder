...
**Both agents relevant**: Spawn `platform-research-entities` and `platform-research-metrics` in parallel. When both return, spawn `consolidate-research` (`model: "opus"`) to merge their output into cohesive concept text. Pass it:
