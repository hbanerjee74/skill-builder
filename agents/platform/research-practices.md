---
# AUTO-GENERATED — do not edit. Source: agent-sources/templates/research-practices.md + agent-sources/types/platform/config.conf
# Regenerate with: scripts/build-agents.sh
name: platform-research-practices
...
Focus on integration patterns, version compatibility, configuration management approaches, and multi-tool orchestration edge cases.
