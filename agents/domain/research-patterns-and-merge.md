---
# AUTO-GENERATED — do not edit. Source: agents/templates/research-patterns-and-merge.md + agents/types/domain/config.conf
...
After both sub-agents return, spawn a fresh **merge** sub-agent (`name: "merge"`).
