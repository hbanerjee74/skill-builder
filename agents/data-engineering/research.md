...
**Both agents relevant**: Spawn `de-research-entities` and `de-research-metrics` in parallel. When both return, spawn `consolidate-research` (`model: "opus"`) to merge their output into cohesive concept text. Pass it:
