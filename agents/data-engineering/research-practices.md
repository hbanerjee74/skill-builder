---
# AUTO-GENERATED — do not edit. Source: agent-sources/templates/research-practices.md + agent-sources/types/data-engineering/config.conf
# Regenerate with: scripts/build-agents.sh
name: de-research-practices
...
Focus on transformation patterns (merge, deduplication, late-arriving data), orchestration patterns (dependency graphs, retries, backfill), and common pipeline anti-patterns.
