...
assert_row_contains "reasoning-chat → integration"    "reasoning-chat.tsx"      "reasoning-chat.test.tsx"
assert_row_contains "reasoning-chat → E2E tag"        "reasoning-chat.tsx"      "@workflow"
...
assert_row_contains "reasoning-parser → integration"  "reasoning-parser.ts"     "reasoning-chat.test.tsx"
