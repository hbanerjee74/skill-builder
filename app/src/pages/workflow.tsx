...
const STEP_CONFIGS: Record<number, StepConfig> = {
  0: { type: "agent", outputFiles: ["context/clarifications-concepts.md", "context/clarifications-practices.md", "context/clarifications-implementation.md", "context/clarifications.md"], model: "sonnet" },
  1: { type: "human" },
