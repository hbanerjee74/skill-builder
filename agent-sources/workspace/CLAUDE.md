...
Content principles, skill structure rules, quality dimensions, stack conventions, and anti-patterns are maintained in the `skill-builder-practices` skill at `.claude/skills/skill-builder-practices/`. Agents generating, validating, or refining skills should read that skill's SKILL.md and reference files.

When the skill is active, its trigger text appears in the Imported Skills section below.
