...
- `agents/` -- 28 agents (18 research dimensions + planner + orchestrator + scope-advisor + consolidate-research + detailed-research + confirm-decisions + generate-skill + validate-skill + validate-quality + validate-companion-recommender)
