...
1. **Research** -- research orchestrator dynamically selects concept agents (entity, metrics) based on domain analysis, spawns practices + implementation sub-agents, consolidation agent produces `clarifications.md`
